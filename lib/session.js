...
module.exports = {
  ...
  register: async (server, options) => {
    console.log(`${options} options session start`);
    logger.info(`${options} options session start`);
    ...
    server.route({
      ...
      handler: (req, h) => {
        ...
        console.log(`${state}: state session login`);
        logger.info(`${state}: state session login`);
        console.log(`${nonce}: nonce session login`);
        logger.info(`${nonce}: nonce session login`);
        console.log(`${options}: options session login`);
        logger.info(`${options}: options session login`);
    ...
    server.route({
      ...
      handler: async (req, h) => {
        ...
        try {
          ...
          console.log(`${decoded}: decoded session login/callback`);
          logger.info(`${decoded}: decoded session login/callback`);
          ...
          console.log(`${key}: key session login/callback`);
        ...
        console.log(`${req.state}: req.state session login/callback`);
        logger.info(`${req.state}: req.state session login/callback`);
        if (
          (
        ...
        try {
          ...
          console.log(`${token}: token session login/callback`);
          logger.info(`${token}: token session login/callback`);
        } catch (error) {
