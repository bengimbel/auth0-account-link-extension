...
function fromHapi(serverFactory) {
  ...
  return async (context, req, res) => {
    console.log(`context string: ${JSON.stringify(context)}`);
...
function attachStorageHelpers(context) {
  console.log(`${context.secrets.EXT_STORAGE_URL}, EXT_STORAGE_URL`);
  console.log(`${JSON.stringify(context.secrets.EXT_STORAGE_URL)}, EXT_STORAGE_URL`);
